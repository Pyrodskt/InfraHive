...
class Server(Base):
    ...
    networks: Mapped[List["ServerHasNetwork"]] = relationship(back_populates="server") #INCR
...
class Network(Base):
    ...
    servers: Mapped[List["ServerHasNetwork"]] = relationship(back_populates="network") #INCR
